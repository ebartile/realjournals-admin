...
function SettingsProvider({ children }) {
  ...
  const saveSettings = useCallback(
    (name, value) => {
      request.post(route(name), value).catch((error) => {
  ...
  const onChangeMode = (event) => {
    ...
    saveSettings('admin.theme.set-theme', { mode: event.target.value });
  };
  ...
  const onChangeDirection = (event) => {
    ...
    saveSettings('admin.theme.set-theme', { direction: event.target.value });
  };
  ...
  const onChangeColor = (event) => {
    ...
    saveSettings('admin.theme.set-theme', { color: event.target.value });
  };
  ...
  const onToggleStretch = (event) => {
    ...
    saveSettings('admin.theme.set-theme', { stretch: !settings.themeStretch });
  };
