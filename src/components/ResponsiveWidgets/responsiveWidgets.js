...
const ResponsiveWidgets = ({ widgets, page }) => {
  ...
  const save = useCallback(() => {
    request
      .post(route('user.admin-page-set-dimensions', { id: auth.user.id }), { dimensions, page })
      .then(() => {
        setEditable(false);
